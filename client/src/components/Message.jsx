...
export function Message(props) {
  ...
  return (
    ...
    >
      ...
      <section
        style={{opacity: '0.8'}}
        className="h-[calc(100vh-128px)] overflow-x-hidden overflow-y-scroll scrollbar relative bg-slate-200 bg-opacity-75"
      >
      ...
      <section className="h-16 bg-white flex items-center px-4">
        ...
        <form className="h-full w-full flex gap-2" onSubmit={handleSendMessage}>
          ...
          />
          <button className="text-blue-500 hover:text-secondary">
            <IoMdSend size={28} />
          </button>
        </form>
      </section>
